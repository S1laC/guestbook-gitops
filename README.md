...
│   ├── 🌐 Domain: guestbook-sila.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-sila.duckdns.org/
...
- DNS record pointing `guestbook-sila.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/s1lac/guestbook-gitops
   ```
